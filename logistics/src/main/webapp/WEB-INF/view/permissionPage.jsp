...
<script type="text/javascript">
			...
			*/
			...
			columns: [ //表格显示数据对应的表头设置，
				...
				*/
				...
				{field: 'type',title: '权限类型',formatter:typeFormatter},
	...
	function typeFormatter(value,row,index){
		...
		var html= "<span style='color:red'>普通权限</span>";
		if(value == 'menu'){
			html= "<span style='color:green'>菜单权限</span>";
		}
		return html;
	...
	/* 
		...
		value ：当前行的 值  field:'permissionId'
		row ：当前行对应的json对象
		index ：索引 ,从0开始
