...
<script type="text/javascript">
	...
	*/
	function operationFormatter(value,row,index){
		...
		html += "<span onclick='customer_del("+value+")' style='color:red;cursor: pointer;' class='glyphicon glyphicon-trash'></span>&nbsp;&nbsp;";		
		html +='</shiro:hasPermission>';
		html +='<shiro:hasPermission name="customer:update">'
		html += "<span onclick='customer_edit("+value+")' style='color:blue;cursor: pointer;' class='glyphicon glyphicon-pencil'></span>";		
		html +='</shiro:hasPermission>';
...
function customer_add(){
	layer_show("添加客户","customer/edit.do",$(window).width(),$(window).height());
}
/*客户-编辑*/
function customer_edit(customerId){
	layer_show("修改客户","customer/edit.do?customerId="+customerId);
}
